...
public class Test {
    ...
    public static void main(String[] args) {
		...
		// 	runningScore += ArcadeMachine.runOneGame(game, level1, visuals, sampleGAController, recordActionsFile, seed, 0)[1];
		// }
	...
	//	 ArcadeMachine.replayGame(game, level1, visuals, readActionsFile);
		...
		// 	}
		//  	ArcadeMachine.runGames(game, levels, M, sampleRandomController, saveActions? actionFiles:null);
		// }
